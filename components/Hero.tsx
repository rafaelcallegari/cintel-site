    ...
    <>
      ...
      <header className="relative text-white min-h-[600px] h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-10 md:py-14">
          ...
          <div className="hero-title flex flex-col items-center justify-center min-h-[120px] md:min-h-[150px]">
            <h1
              className={`text-4xl md:text-6xl lg:text-7xl font-extrabold mb-4 text-white font-alegreya leading-tight transition-all duration-700 ease-in-out ${
                isVisible
            ...
            {/* Linha animada */}
            <div className="h-1.5 w-32 bg-cintelYellow mx-auto mb-6 origin-center animate-grow-line"></div>
          </div>

          {/* Parágrafo — fade-in com delay 0.2s */}
          <p className="hero-subtitle text-lg md:text-xl max-w-3xl mx-auto mb-8 font-alegreya leading-relaxed text-white/80">
          ...
          <div className="hero-ctas-primary flex flex-col sm:flex-row justify-center items-center gap-4 mb-4">
            <a
              href="/market/analise-imovel"
              className="w-full sm:w-auto bg-cintelYellow text-gray-800 px-10 py-4 rounded-full font-black text-lg uppercase tracking-wide hover:brightness-110 transition-all duration-300 transform hover:scale-105 shadow-[0_8px_30px_rgba(221,234,189,0.45)]"
            >
              Buscar vocação do ponto
            </a>
            <a
              href="/market/mapa-de-calor"
              className="w-full sm:w-auto bg-white text-[#303030] px-10 py-4 rounded-full font-black text-lg uppercase tracking-wide hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-[0_8px_30px_rgba(255,255,255,0.2)]"
            >
          ...
          <div className="hero-ctas-secondary flex flex-col sm:flex-row justify-center items-center gap-4 mt-2">
            <a
              href="#analise"
              className="w-full sm:w-auto border-2 border-white/30 text-white/80 px-8 py-3 rounded-full font-semibold hover:bg-white/10 hover:text-white transition-colors duration-300"
            >
              Analisar meu endereço
            </a>
            <a
              href="https://wa.me/5511996852374"
              className="w-full sm:w-auto flex items-center justify-center gap-2 border-2 border-white/30 text-white/80 px-8 py-3 rounded-full font-semibold hover:bg-white/10 hover:text-white transition-colors duration-300"
            >
              <img
          ...
          <div className="hero-scroll mt-8">
